...
class Bengkel extends CI_Controller 
{
    ...
    public function tambah_alternatif()
    {
        ...
        $this->form_validation->set_rules('Nama_Alternatif', 'Nama Bengkel', 'required',
        ...
        $this->form_validation->set_rules('Telepon_Alternatif', 'Telepon Bengkel', 'required|numeric',
            array('required'=>'Telepon Bengkel tidak boleh kosong!', 'numeric'=>'Telepon hanya diperbolehkan angka!'));
        ...
        if($this->form_validation->run() != false) {
            ...
            if ( !$this->upload->do_upload('Gambar_Alternatif')){
                ...
                Gambar / Foto tidak boleh kosong. Format Gambar .jpg dan .png!
                </div>');
    ...
    public function update_alternatif()
    {
        ...
        $Nama_Alternatif = $this->db->escape_str($this->input->post('Nama_Alternatif'));
        $Alamat_Alternatif = $this->db->escape_str($this->input->post('Alamat_Alternatif'));
        $Telepon_Alternatif = $this->db->escape_str($this->input->post('Telepon_Alternatif'));
        $JamOperasional_Alternatif = $this->db->escape_str($this->input->post('JamOperasional_Alternatif'));
        $Latitude_Alternatif = $this->db->escape_str($this->input->post('Latitude_Alternatif'));
        $Longitude_Alternatif = $this->db->escape_str($this->input->post('Longitude_Alternatif'));
        $Direction = $this->db->escape_str($this->input->post('Direction'));
        ...
        if ( !$this->upload->do_upload('Gambar_Alternatif')){
            $old_pic = $this->db->escape_str($this->input->post('Old_Gambar'));
...
//=================================== END MATRIX ===================================
            ...
            if($this->form_validation->run() != false) {
                ...
                if ($id_ktg == 1 || $id_ktg == 2) {
                    ...
                    $this->form_validation->set_rules('Nama_Layanan', 'Nama Layanan', 'required',
                        array('required'=>'Nama Layanan tidak boleh kosong!'));
                    $this->form_validation->set_rules('Isi_Deskripsi', 'Deskripsi', 'required',
                        array('required'=>'Deskripsi Layanan tidak boleh kosong!'));
                    $this->form_validation->set_rules('Harga_Kategori', 'Harga', 'required|integer',
                        array('required'=>'Harga tidak boleh kosong!', 'numeric'=>'Harga hanya diperbolehkan angka!'));
                    ...
                    $this->form_validation->set_rules('Nama_Onderdil', 'Nama Onderdil',
                        array('required'=>'Nama Onderdil tidak boleh kosong!'));
                    ...
                    $this->form_validation->set_rules('Isi_Deskripsi', 'Deskripsi',
                        array('required'=>'Deskripsi Onderdil tidak boleh kosong!'));
                    $this->form_validation->set_rules('Harga_Kategori', 'Harga', 'required|integer',
       ...
       public function edit_kategori_detail($ID_Kategori_Detail)
       {
        ...
        public function update_kategori_detail()
        {
            ...
            $nama_lo = $this->db->escape_str($this->input->post('Isi_Kategori'));
            ...
            if ($ID_Kategori < 3) {
                $id_jl = $this->db->escape_str($this->input->post('ID_JL'));
                $harga = $this->db->escape_str($this->input->post('Harga_Kategori'));
                $deskripsi = $this->db->escape_str($this->input->post('Isi_Deskripsi'));
                ...
                if ( !$this->upload->do_upload('Gambar_Kategori')){
                    ...
                    $data = array(
                        ...
                        'ID_JL'        => $id_jl,
                        'Isi_Kategori'      => $nama_lo,
                        'Harga_Kategori'       => $harga,
                        'Isi_Deskripsi' => $deskripsi,
                        'Gambar_Isi_Kategori' => $old_pic
                    );
                    $where = array('ID_Kategori_Detail' => $ID_Kategori_Detail);
                    // memanggil sebuah method update_data untuk di model
                ...
                $id_jo = $this->db->escape_str($this->input->post('ID_JO2'));
                $id_mm = $this->db->escape_str($this->input->post('ID_MM2'));
                $id_tm = $this->db->escape_str($this->input->post('ID_TM2'));
                $id_mo = $this->db->escape_str($this->input->post('ID_MO2'));
                $harga = $this->db->escape_str($this->input->post('Harga_Kategori'));
                $deskripsi = $this->db->escape_str($this->input->post('Isi_Deskripsi'));
 ...
 public function tambah_data_pBengkel($ID_Pengajuan)
 {
    ...
    foreach ($data_bengkel as $dataPB) {
        ...
        $Gambar_Objek = $dataPB->Gambar_Objek1;
    }
    ...
    // Kirim Email
    // $message_email = "http://localhost:8080/bengkel/pengajuan/beranda_akun";
    ...
    $data = array(
		...
		'Gambar_Alternatif' => $Gambar_Objek,
    );
 ...
 public function update_saringTM()
 {
    ...
    public function get_jenis_layanan2()
    {
        $id_ktg = $this->input->post('ID_Kategori');
        $id_jl = $this->input->post('ID_JL');
		...
		$this->db->where("ID_JL", $id_jl);
		$query = $this->db->get();
		foreach ($query->result() as $ktg) :
			$jl = '<option value="'.$ktg->ID_JL.'" selected>'.$ktg->Nama_JL.'</option>';
		endforeach; 
    ...
    public function get_jenis_onderdil2()
    {
        $id_ktg = $this->input->post('ID_Kategori');
        $id_jo = $this->input->post('ID_JO');
		...
		$query = $this->db->get();
		foreach ($query->result() as $ktg) :
			$jo = '<option value="'.$ktg->ID_JO.'" selected>'.$ktg->Nama_JO.'</option>';
		endforeach; 
    ...
    public function get_merek_motor()
    {
        ...
        $query = $this->db->get();
        foreach ($query->result() as $ktg) :
			$mm = '<option value="'.$ktg->ID_MM.'" selected>'.$ktg->Nama_MM.'</option>';
        endforeach;
        ...
        foreach ($saring_merek_motor->result() as $sMM) :
            echo '<option value="'.$sMM->ID_MM.'">'.$sMM->Nama_MM.'</option>';	
        endforeach;
    }
